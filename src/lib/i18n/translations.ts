...
export const translations: Record<LanguageCode, AppTranslations> = {
  ...
  es: {
    ...
    landing: {
      ...
      featuresTitle: "Características que realmente marcan la diferencia",
      arbitrageTitle: "Potencia tus ganancias",
      ...
      features: [
        ...
        },
        {
          ...
          description:
            "Accede a información veraz y directa del mercado. Sin promesas vacías, solo las oportunidades que realmente existen.",
        },
        {
          title: "Simplicidad y Eficacia",
          description:
            "Una interfaz diseñada para que encuentres lo que buscas en segundos. Menos ruido, más rentabilidad.",
        },
        {
          title: "Inteligencia Financiera",
          description:
            "Calculadora integrada que optimiza cada céntimo de tu inversión, gestionando el riesgo automáticamente.",
        },
      ],
      pricingPlans: [
        {
          name: "FREE",
          price: { eur: 0, gbp: 0 },
          tagline: "Prueba la potencia de la plataforma durante 7 días.",
          features: [
            "Acceso completo de prueba (7 días)",
            "Funcionalidades del plan Standard",
            "Sin compromiso",
            "Escaneo básico",
          ],
          isFree: true,
        ...
        {
          name: "STANDARD",
          price: { eur: 14.95, gbp: 12.95 },
          tagline: "Ideal para comenzar a rentabilizar tu capital.",
          features: [
            "Arbitrajes de partidos futuros",
            "Rentabilidad máx. de 5%",
            "Deportes: Baloncesto y Tenis",
            "Alertas estándar",
          ],
          cta: "Elegir Standard",
        },
